...
class UiLinearLayout @JvmOverloads constructor(
    ...
    init {
        context.theme.obtainStyledAttributes(attrs, R.styleable.UiLinearLayout, defStyleAttr, 0).apply {
            ...
            stColorDark = getColor(R.styleable.UiLinearLayout_stColorDark, Color.BLACK)
            stColorLight = getColor(R.styleable.UiLinearLayout_stColorLight, Color.BLACK)
            ...
            bgGradientStart = getColor(R.styleable.UiLinearLayout_bgGradientStart, Color.TRANSPARENT)
            bgGradientCenter = getColor(R.styleable.UiLinearLayout_bgGradientCenter, Color.TRANSPARENT)
            bgGradientEnd = getColor(R.styleable.UiLinearLayout_bgGradientEnd, Color.TRANSPARENT)
            isGradient = bgGradientStart != Color.TRANSPARENT && bgGradientEnd != Color.TRANSPARENT
            isDistance = getBoolean(R.styleable.UiLinearLayout_strokeDistance, false)
            distanceSpace = getDimension(R.styleable.UiLinearLayout_distanceSpace, 10f)

            val gradient = getString(R.styleable.UiLinearLayout_strokeGradient)
            ...
            gradientOrientation = when (getInt(R.styleable.UiLinearLayout_bgGdOrientation, 0)) {
            ...
            strokeGradientOrientation = when (getInt(R.styleable.UiLinearLayout_strokeGdOrientation, 6)) {
    ...
    private fun updateGradient() {
        ...
        val backgroundDrawable = GradientDrawable(
            ...
            cornerRadius = this@UiLinearLayout.cornerRadius
        }
