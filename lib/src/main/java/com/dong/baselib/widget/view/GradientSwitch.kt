...
class GradientSwitch @JvmOverloads constructor(
    ...
    private var trackColorOff: IntArray = intArrayOf(fromColor("#E0E0E0"), fromColor("#E0E0E0"))
    private var thumbColorOff: IntArray = intArrayOf(fromColor("#FFFFFF"), fromColor("#FFFFFF"))
    private var trackColorOn: IntArray = intArrayOf(fromColor("#5B6CF9"),fromColor("#3965FC"), fromColor("#a382ea"))
