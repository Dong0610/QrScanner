...
) : ConstraintLayout(context, attrs, defStyleAttr)
{
    ...
    init {
        attrs?.let {
            val typedArray = context.obtainStyledAttributes(it, R.styleable.UiConstraintLayout)
            cornerRadius = typedArray.getDimension(R.styleable.UiConstraintLayout_cornerRadius, 0f)
            stWidth = typedArray.getDimension(R.styleable.UiConstraintLayout_strokeWidth, 0f)
            stColorDark = typedArray.getColor(R.styleable.UiConstraintLayout_stColorDark, Color.BLACK)
            stColorLight = typedArray.getColor(R.styleable.UiConstraintLayout_stColorLight, Color.BLACK)
            bgColorDark = typedArray.getColor(R.styleable.UiConstraintLayout_bgColorDark, Color.TRANSPARENT)
            bgColorLight =
                typedArray.getColor(R.styleable.UiConstraintLayout_bgColorLight, Color.TRANSPARENT)
            bgGradientStart =
                typedArray.getColor(R.styleable.UiConstraintLayout_bgGradientStart, Color.TRANSPARENT)
            bgGradientCenter =
                typedArray.getColor(R.styleable.UiConstraintLayout_bgGradientCenter, Color.TRANSPARENT)
            bgGradientEnd =
                typedArray.getColor(R.styleable.UiConstraintLayout_bgGradientEnd, Color.TRANSPARENT)
            isGradient = bgGradientStart != Color.TRANSPARENT && bgGradientEnd != Color.TRANSPARENT
            isDistance = typedArray.getBoolean(R.styleable.UiConstraintLayout_strokeDistance, false)
            distanceSpace = typedArray.getDimension(R.styleable.UiConstraintLayout_distanceSpace, 10f)

            val gradient = typedArray.getString(R.styleable.UiConstraintLayout_strokeGradient)
            ...
            gradientOrientation =
                when (typedArray.getInt(R.styleable.UiConstraintLayout_bgGdOrientation, 0)) {
            ...
            strokeGradientOrientation =
                when (typedArray.getInt(R.styleable.UiConstraintLayout_strokeGdOrientation, 6)) {
    ...
    private fun updateGradient() {
        val backgroundDrawable = GradientDrawable(
            ...
            cornerRadius = this@UiConstraintLayout.cornerRadius
        }
