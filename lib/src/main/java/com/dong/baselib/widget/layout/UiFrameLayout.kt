...
) : FrameLayout(context, attrs, defStyleAttr)
{
    ...
    init {
        attrs?.let {
            val typedArray = context.obtainStyledAttributes(it, R.styleable.UiFrameLayout)
            cornerRadius = typedArray.getDimension(R.styleable.UiFrameLayout_cornerRadius, 0f)
            stWidth = typedArray.getDimension(R.styleable.UiFrameLayout_strokeWidth, 0f)
            stColorDark = typedArray.getColor(R.styleable.UiFrameLayout_stColorDark, Color.BLACK)
            stColorLight = typedArray.getColor(R.styleable.UiFrameLayout_stColorLight, Color.BLACK)
            bgColorDark = typedArray.getColor(R.styleable.UiFrameLayout_bgColorDark, Color.TRANSPARENT)
            bgColorLight =
                typedArray.getColor(R.styleable.UiFrameLayout_bgColorLight, Color.TRANSPARENT)
            bgGradientStart =
                typedArray.getColor(R.styleable.UiFrameLayout_bgGradientStart, Color.TRANSPARENT)
            bgGradientCenter =
                typedArray.getColor(R.styleable.UiFrameLayout_bgGradientCenter, Color.TRANSPARENT)
            bgGradientEnd =
                typedArray.getColor(R.styleable.UiFrameLayout_bgGradientEnd, Color.TRANSPARENT)
            isGradient = bgGradientStart != Color.TRANSPARENT && bgGradientEnd != Color.TRANSPARENT
            isDistance = typedArray.getBoolean(R.styleable.UiFrameLayout_strokeDistance, false)
            distanceSpace = typedArray.getDimension(R.styleable.UiFrameLayout_distanceSpace, 10f)

            val gradient = typedArray.getString(R.styleable.UiFrameLayout_strokeGradient)
            ...
            gradientOrientation =
                when (typedArray.getInt(R.styleable.UiFrameLayout_bgGdOrientation, 0)) {
            ...
            strokeGradientOrientation =
                when (typedArray.getInt(R.styleable.UiFrameLayout_strokeGdOrientation, 6)) {
