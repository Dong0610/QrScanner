...
class UiRowLayout @JvmOverloads constructor(
    ...
    private var maxItemInRow: Int = 0

    init {
        context.theme.obtainStyledAttributes(
            attrs,
            R.styleable.UiRowLayout,
            defStyleAttr,
            0
        ).apply {
            ...
            stColorDark = getColor(R.styleable.UiRowLayout_stColorDark, Color.BLACK)
            stColorLight = getColor(R.styleable.UiRowLayout_stColorLight, Color.BLACK)
            bgColorDark = getColor(R.styleable.UiRowLayout_bgColorDark, Color.TRANSPARENT)
            bgColorLight =
                getColor(R.styleable.UiRowLayout_bgColorLight, Color.TRANSPARENT)
            bgGradientStart =
            ...
            isDistance = getBoolean(R.styleable.UiRowLayout_strokeDistance, false)
            distanceSpace = getDimension(R.styleable.UiRowLayout_distanceSpace, 10f)

            val gradient = getString(R.styleable.UiRowLayout_strokeGradient)
            ...
            gradientOrientation =
                when (getInt(R.styleable.UiRowLayout_bgGdOrientation, 0)) {
            ...
            strokeGradientOrientation =
                when (getInt(R.styleable.UiRowLayout_strokeGdOrientation, 6)) {
            ...
            maxItemInRow = getInt(R.styleable.UiRowLayout_maxItemsInRow, 0)
