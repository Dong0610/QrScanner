package net.blwsmartware.qrcodescanner.qrgenerator.vector

import androidx.annotation.FloatRange
import net.blwsmartware.qrcodescanner.qrgenerator.QrHighlighting
...
import net.blwsmartware.qrcodescanner.qrgenerator.vector.dsl.InternalQrVectorOptionsBuilderScope
import net.blwsmartware.qrcodescanner.qrgenerator.vector.dsl.QrVectorOptionsBuilderScope
import net.blwsmartware.qrcodescanner.qrgenerator.vector.style.QrVectorBackground
import net.blwsmartware.qrcodescanner.qrgenerator.vector.style.QrVectorColors
import net.blwsmartware.qrcodescanner.qrgenerator.vector.style.QrVectorLogo
import net.blwsmartware.qrcodescanner.qrgenerator.vector.style.QrVectorShapes
